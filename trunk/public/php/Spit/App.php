...
require "Path.php";
require "IssueFields.php";
require "EditorMode.php";
require "TitleMode.php";
require "UserType.php";
require "HttpCode.php";
require "Importer.php";
require "ChangeResolver.php";
require "LinkProvider.php";
require "DateFormatter.php";
require "SessionManager.php";

require "Controllers/ControllerProvider.php";
require "Controllers/ErrorController.php";
require "Controllers/SetupController.php";

require "DataStores/DataStore.php";
require "DataStores/IssueDataStore.php";
require "DataStores/ProjectDataStore.php";
require "DataStores/ChangeDataStore.php";
require "DataStores/StatusDataStore.php";
require "DataStores/TrackerDataStore.php";
require "DataStores/PriorityDataStore.php";
require "DataStores/VersionDataStore.php";
require "DataStores/UserDataStore.php";
require "DataStores/RedmineDataStore.php";
require "DataStores/AssigneeDataStore.php";
require "DataStores/CategoryDataStore.php";
require "DataStores/RelationDataStore.php";
require "DataStores/AttachmentDataStore.php";
require "DataStores/MemberDataStore.php";
require "DataStores/QueryDataStore.php";

require "Models/Link.php";
require "Models/Issue.php";
require "Models/Project.php";
require "Models/Change.php";
...
require "Models/Fields/SelectField.php";
require "Models/Fields/TableField.php";
require "Models/Fields/TextField.php";
require "Models/Fields/DisplayField.php";
